...
class EventPage extends StatefulWidget {
  ...
  void fabOnPress(BuildContext context) {
    Navigator.of(context).push(new MaterialPageRoute(
        builder: (BuildContext context) => new ScanBarcodePage(_eventID)));
  }
}
...
class EventPageState extends State<EventPage>
  ...
  void _scanTickets() {
    Navigator.of(context).push(new MaterialPageRoute(
        builder: (context) => new ScanBarcodePage(widget._eventID)));
  }
  ...
  void adminPrivileges() async {
    ...
    Firestore.instance
        .document("events/" + widget._eventID + "/administrators/" + user.uid)
        .snapshots
